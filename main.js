...
window.addEventListener("load", function() {
    ...
    } else if (!floorPlanner.meta.title) {
    ...
    ujAlaprajzLetrehozasModalElement.on('hidden.bs.modal', function() {
        if (help('#inputAlaprajzNeve').val().length) {
            floorPlanner.meta.title = help('#inputAlaprajzNeve').val();
    ...
    if (floorPlanner.meta.title) {
        help('#floorplan-name').html(floorPlanner.meta.title);
    }
